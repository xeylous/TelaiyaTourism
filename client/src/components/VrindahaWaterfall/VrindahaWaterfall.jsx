...
import { MapPin, Clock, Calendar, ArrowLeft, Navigation, Camera, Info, Droplets } from 'lucide-react';
import Navbar from '../Navbar/Navbar';
import Footer from '../Footer/Footer';
import BrindahaImage from '../../Images/Brindaha_img.png';
...
const VrindahaWaterfall = () => {
  const images = [BrindahaImage, BrindahaImage, BrindahaImage];

  const highlights = [
    { icon: <Clock className="w-5 h-5" />, label: "Best Time", value: "July - Sept" },
    ...
    <div className="flex flex-col min-h-screen font-sans text-zinc-900 dark:text-zinc-100 bg-zinc-50 dark:bg-zinc-950 transition-colors duration-300">
      ...
      <header className="relative h-[60vh] md:h-[70vh] w-full overflow-hidden">
        <div
          ...
          style={{
            backgroundImage: `url(${BrindahaImage})`,
            ...
            <div className="order-2 lg:order-1 space-y-8">
              ...
              <div className="bg-white dark:bg-zinc-900 rounded-2xl p-8 border border-zinc-200 dark:border-zinc-800 shadow-lg dark:shadow-none">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-2xl font-display font-bold text-zinc-900 dark:text-white">About Vrindaha Waterfall</h2>
                </div>
                
                <div className="prose dark:prose-invert max-w-none">
                  <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed mb-4">
                    Vrindaha Waterfall is a <strong className="text-zinc-900 dark:text-white">hidden gem</strong> nestled in the lush forests of Koderma district. This spectacular cascade is one of the most serene and untouched natural wonders in the region.
                  </p>
                  <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed mb-4">
                    The waterfall is surrounded by dense greenery and offers a refreshing escape from the hustle and bustle of city life. The cascading waters create a mesmerizing sight, especially during the monsoon season when the flow is at its peak.
                  </p>
                  <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
                    Visitors can enjoy the cool mist from the falls, take scenic photographs, and immerse themselves in the tranquil atmosphere. The trek to the waterfall through the forest adds to the adventure.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-zinc-900 rounded-2xl p-8 border border-zinc-200 dark:border-zinc-800 shadow-lg dark:shadow-none">
                ...
                <div className="w-full h-[300px] rounded-xl overflow-hidden mb-6 border border-zinc-200 dark:border-zinc-700">
                  <iframe
                    title="Vrindaha Waterfall Location"
                ...
                <a
                  href="https://www.google.com/maps/dir/?api=1&destination=Vrindaha+Waterfall+Koderma"
                  target="_blank"
              ...
              <div className="bg-gradient-to-r from-blue-600 to-blue-700 dark:from-cyan-600 dark:to-blue-600 rounded-2xl p-8 text-white">
                ...
                <p className="text-white/80 mb-6">Book your trip to Vrindaha Waterfall and experience nature's beauty.</p>
                <Link
                  to="/book"
...
export default VrindahaWaterfall;
