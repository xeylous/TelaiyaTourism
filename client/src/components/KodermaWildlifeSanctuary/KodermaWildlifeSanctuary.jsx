...
import { MapPin, Clock, Calendar, ArrowLeft, Navigation, Info, TreePine } from 'lucide-react';
import Navbar from '../Navbar/Navbar';
import Footer from '../Footer/Footer';
import WildlifeSanctuaryImage from '../../Images/WildlifeSanctuary.jpg';
...
const KodermaWildlifeSanctuary = () => {
  const images = [WildlifeSanctuaryImage, WildlifeSanctuaryImage, WildlifeSanctuaryImage];

  const highlights = [
    { icon: <Clock className="w-5 h-5" />, label: "Best Time", value: "Oct - March" },
    { icon: <Calendar className="w-5 h-5" />, label: "Duration", value: "4-6 Hours" },
    ...
    <div className="flex flex-col min-h-screen font-sans text-zinc-900 dark:text-zinc-100 bg-zinc-50 dark:bg-zinc-950 transition-colors duration-300">
      ...
      <header className="relative h-[60vh] md:h-[70vh] w-full overflow-hidden">
        <div
          ...
          style={{
            backgroundImage: `url(${WildlifeSanctuaryImage})`,
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-xl dark:shadow-none border border-zinc-200 dark:border-zinc-800 p-6 grid grid-cols-3 gap-4">
          {highlights.map((item, idx) => (
            <div key={idx} className="flex flex-col items-center text-center">
              <div className="p-3 bg-green-50 dark:bg-green-500/10 rounded-xl text-green-600 dark:text-green-400 mb-2">
                {item.icon}
              </div>
                ...
                >
                  {images.map((img, idx) => (
                    <SwiperSlide key={idx}>
                      <img
                        src={img}
                        alt={`Koderma Wildlife Sanctuary ${idx + 1}`}
            ...
            <div className="order-2 lg:order-1 space-y-8">
              ...
              <div className="bg-white dark:bg-zinc-900 rounded-2xl p-8 border border-zinc-200 dark:border-zinc-800 shadow-lg dark:shadow-none">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-2xl font-display font-bold text-zinc-900 dark:text-white">About Koderma Wildlife Sanctuary</h2>
                </div>
                
                <div className="prose dark:prose-invert max-w-none">
                  <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed mb-4">
                    Koderma Wildlife Sanctuary is a <strong className="text-zinc-900 dark:text-white">pristine natural reserve</strong> spread across dense forests in the Koderma district. Established to protect the region's rich biodiversity, it is home to a variety of wildlife species.
                  </p>
                  <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed mb-4">
                    The sanctuary features diverse ecosystems including deciduous forests, grasslands, and rocky terrains. Visitors can spot animals such as leopards, deer, wild boars, and numerous bird species in their natural habitat.
                  </p>
                  <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
                    Nature trails wind through the sanctuary, offering opportunities for wildlife photography, bird watching, and nature walks. The sanctuary is an ideal destination for eco-tourism enthusiasts and those seeking to connect with nature.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-zinc-900 rounded-2xl p-8 border border-zinc-200 dark:border-zinc-800 shadow-lg dark:shadow-none">
                ...
                <div className="w-full h-[300px] rounded-xl overflow-hidden mb-6 border border-zinc-200 dark:border-zinc-700">
                  <iframe
                    title="Koderma Wildlife Sanctuary Location"
                ...
                <a
                  href="https://www.google.com/maps/dir/?api=1&destination=Koderma+Wildlife+Sanctuary"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 w-full justify-center px-6 py-4 bg-green-600 dark:bg-green-500 text-white font-bold rounded-xl hover:bg-green-700 dark:hover:bg-green-400 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                >
              ...
              {/* Book Trip CTA */}
              <div className="bg-gradient-to-r from-green-600 to-emerald-600 dark:from-green-600 dark:to-teal-600 rounded-2xl p-8 text-white">
                <h3 className="text-2xl font-display font-bold mb-3">Ready to Visit?</h3>
                <p className="text-white/80 mb-6">Book your trip to Koderma Wildlife Sanctuary and explore nature's wonders.</p>
                <Link
                  to="/book"
                  className="inline-flex items-center gap-2 px-6 py-3 bg-white text-green-600 font-bold rounded-xl hover:bg-zinc-100 transition-all"
                >
                  Book Your Trip
...
export default KodermaWildlifeSanctuary;
