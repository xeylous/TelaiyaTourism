...
import RadhaKrishnaImage from '../../Images/RadhaKrishnaMandir_img.jpg';
...
const RadhaKrishnaMandir = () => {
  const images = [RadhaKrishnaImage, RadhaKrishnaImage, RadhaKrishnaImage];
    ...
    <div className="flex flex-col min-h-screen font-sans text-zinc-900 dark:text-zinc-100 bg-zinc-50 dark:bg-zinc-950 transition-colors duration-300">
      ...
      <header className="relative h-[60vh] md:h-[70vh] w-full overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-display font-bold text-white drop-shadow-lg mb-6 tracking-tighter">
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-xl dark:shadow-none border border-zinc-200 dark:border-zinc-800 p-6 grid grid-cols-3 gap-4">
          {highlights.map((item, idx) => (
            <div key={idx} className="flex flex-col items-center text-center">
              <div className="p-3 bg-purple-50 dark:bg-purple-500/10 rounded-xl text-purple-600 dark:text-purple-400 mb-2">
                {item.icon}
              </div>
                ...
                >
                  {images.map((img, idx) => (
                    <SwiperSlide key={idx}>
                      <img
                        src={img}
                        alt={`Radha Krishna Mandir ${idx + 1}`}
            ...
            <div className="order-2 lg:order-1 space-y-8">
              ...
              <div className="bg-white dark:bg-zinc-900 rounded-2xl p-8 border border-zinc-200 dark:border-zinc-800 shadow-lg dark:shadow-none">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-2xl font-display font-bold text-zinc-900 dark:text-white">About Radha Krishna Mandir</h2>
                </div>
                
                <div className="prose dark:prose-invert max-w-none">
                  <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed mb-4">
                    The Radha Krishna Mandir is a <strong className="text-zinc-900 dark:text-white">sacred temple</strong> dedicated to Lord Krishna and Radha, attracting devotees from across the region. The temple is known for its spiritual ambiance and beautiful architecture.
                  </p>
                  <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed mb-4">
                    The temple complex features intricate carvings and traditional design elements that showcase the rich cultural heritage of the region. Devotees visit throughout the year to seek blessings and participate in religious ceremonies.
                  </p>
                  <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
                    Special celebrations are held during Janmashtami and Holi, when the temple comes alive with vibrant decorations, devotional music, and community gatherings that celebrate the divine love of Radha and Krishna.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-zinc-900 rounded-2xl p-8 border border-zinc-200 dark:border-zinc-800 shadow-lg dark:shadow-none">
                ...
                <div className="w-full h-[300px] rounded-xl overflow-hidden mb-6 border border-zinc-200 dark:border-zinc-700">
                  <iframe
                    title="Radha Krishna Mandir Location"
                ...
                <a
                  href="https://www.google.com/maps/dir/?api=1&destination=Radha+Krishna+Mandir+Koderma"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 w-full justify-center px-6 py-4 bg-purple-600 dark:bg-purple-500 text-white font-bold rounded-xl hover:bg-purple-700 dark:hover:bg-purple-400 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                >
              ...
              {/* Book Trip CTA */}
              <div className="bg-gradient-to-r from-purple-600 to-purple-700 dark:from-purple-600 dark:to-pink-600 rounded-2xl p-8 text-white">
                <h3 className="text-2xl font-display font-bold mb-3">Ready to Visit?</h3>
                <p className="text-white/80 mb-6">Book your trip to Radha Krishna Mandir and experience divine peace.</p>
                <Link
                  to="/book"
                  className="inline-flex items-center gap-2 px-6 py-3 bg-white text-purple-600 font-bold rounded-xl hover:bg-zinc-100 transition-all"
                >
                  Book Your Trip
...
export default RadhaKrishnaMandir;
