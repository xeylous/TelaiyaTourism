...
import { MapPin, Clock, Calendar, ArrowLeft, Navigation, Info, Landmark } from 'lucide-react';
import Navbar from '../Navbar/Navbar';
import Footer from '../Footer/Footer';
import MaaChanchalaImage from '../../Images/panchkheroDam.jpg';
...
const MaaChanchalaDeviMandir = () => {
  const images = [MaaChanchalaImage, MaaChanchalaImage, MaaChanchalaImage];

  const highlights = [
    { icon: <Clock className="w-5 h-5" />, label: "Best Time", value: "All Year" },
    { icon: <Calendar className="w-5 h-5" />, label: "Duration", value: "1-2 Hours" },
    ...
    <div className="flex flex-col min-h-screen font-sans text-zinc-900 dark:text-zinc-100 bg-zinc-50 dark:bg-zinc-950 transition-colors duration-300">
      ...
      <header className="relative h-[60vh] md:h-[70vh] w-full overflow-hidden">
        <div
          ...
          style={{
            backgroundImage: `url(${MaaChanchalaImage})`,
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
          ...
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-display font-bold text-white drop-shadow-lg mb-6 tracking-tighter">
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-xl dark:shadow-none border border-zinc-200 dark:border-zinc-800 p-6 grid grid-cols-3 gap-4">
          {highlights.map((item, idx) => (
            <div key={idx} className="flex flex-col items-center text-center">
              <div className="p-3 bg-orange-50 dark:bg-orange-500/10 rounded-xl text-orange-600 dark:text-orange-400 mb-2">
                {item.icon}
              </div>
                ...
                >
                  {images.map((img, idx) => (
                    <SwiperSlide key={idx}>
                      <img
                        src={img}
                        alt={`Maa Chanchala Devi Mandir ${idx + 1}`}
            ...
            <div className="order-2 lg:order-1 space-y-8">
              ...
              <div className="bg-white dark:bg-zinc-900 rounded-2xl p-8 border border-zinc-200 dark:border-zinc-800 shadow-lg dark:shadow-none">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-2xl font-display font-bold text-zinc-900 dark:text-white">About Maa Chanchala Devi Mandir</h2>
                </div>
                
                <div className="prose dark:prose-invert max-w-none">
                  <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed mb-4">
                    Maa Chanchala Devi Mandir is a <strong className="text-zinc-900 dark:text-white">revered pilgrimage site</strong> dedicated to Goddess Chanchala Devi. The temple holds immense religious significance for devotees who visit from far and wide to seek blessings.
                  </p>
                  <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed mb-4">
                    The temple is nestled in a serene environment, offering a peaceful atmosphere for prayer and meditation. The architecture reflects traditional Hindu temple design with intricate details and sacred symbolism.
                  </p>
                  <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed">
                    During Navratri and other auspicious occasions, the temple witnesses a surge of devotees participating in special pujas and celebrations. The spiritual energy and divine ambiance make this a must-visit destination for those seeking inner peace.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-zinc-900 rounded-2xl p-8 border border-zinc-200 dark:border-zinc-800 shadow-lg dark:shadow-none">
                ...
                <div className="w-full h-[300px] rounded-xl overflow-hidden mb-6 border border-zinc-200 dark:border-zinc-700">
                  <iframe
                    title="Maa Chanchala Devi Mandir Location"
                ...
                <a
                  href="https://www.google.com/maps/dir/?api=1&destination=Maa+Chanchala+Devi+Mandir+Koderma"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 w-full justify-center px-6 py-4 bg-orange-600 dark:bg-orange-500 text-white font-bold rounded-xl hover:bg-orange-700 dark:hover:bg-orange-400 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                >
              ...
              {/* Book Trip CTA */}
              <div className="bg-gradient-to-r from-orange-600 to-red-600 dark:from-orange-600 dark:to-amber-600 rounded-2xl p-8 text-white">
                <h3 className="text-2xl font-display font-bold mb-3">Ready to Visit?</h3>
                <p className="text-white/80 mb-6">Book your trip to Maa Chanchala Devi Mandir and seek divine blessings.</p>
                <Link
                  to="/book"
                  className="inline-flex items-center gap-2 px-6 py-3 bg-white text-orange-600 font-bold rounded-xl hover:bg-zinc-100 transition-all"
                >
                  Book Your Trip
...
export default MaaChanchalaDeviMandir;
